...
const AlertPanel = () => {
    ...
    const handleAddAlert = () => {
        ...
        addAlert({
            ...
            condition: newAlert.type === ALERT_TYPES.PRICE_BELOW ? 'below' : 'above',
            message: `${formatAlertType(newAlert.type)} alert for ${newAlert.symbol}`,
            enabled: true,
            soundEnabled: true,
            notificationEnabled: true,
            type: newAlert.type as any // Cast to any to bypass strict type check for now, or import AlertType
        });
