...
interface CommandTerminalProps {
    onExecute?: (event: { type: string; payload: string }) => void;
}
...
const CommandTerminal: React.FC<CommandTerminalProps> = ({ onExecute }) => {
    ...
    const executeCommand = (cmdItem: CommandItem) => {
        ...
        if (cmdItem.isAsset) {
            ...
            if (cmdItem.action) cmdItem.action();
