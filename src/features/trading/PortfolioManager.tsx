            ...
            <div style={{ flex: 1, overflow: 'auto', padding: '12px' }}>
                ...
                {openPositions.map(position => (
                    <PositionCard
                        ...
                        onClose={(exitPrice: number) => handleClosePosition(position.id, exitPrice)}
                ...
                {showForm && (
                    <NewPositionForm
                        symbol={symbol}
                        currentPrice={currentPrice}
                        onSubmit={(pos: { symbol: string; side: 'long' | 'short'; entry: number; size: number; stopLoss: number | null; takeProfit: number | null }) => {
                            addPosition({
