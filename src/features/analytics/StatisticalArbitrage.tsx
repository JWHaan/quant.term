...
export const StatisticalArbitrage: React.FC<StatisticalArbitrageProps> = ({ returns = [] }) => {
    const analysis = useMemo(() => {
        ...
        for (let i = 1; i < returns.length; i++) {
            const lag = returns[i - 1] || 0;
            const current = returns[i] || 0;
