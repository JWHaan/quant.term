...
export const BacktestingDashboard: React.FC<BacktestingDashboardProps> = ({ trades = [], initialCapital = 10000 }) => {
    ...
    const getRatingColor = (value: number, thresholds: { good: number; ok: number }) => {
