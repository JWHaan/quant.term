...
export const RiskAnalytics: React.FC<RiskAnalyticsProps> = ({ price = 0, volatility = 0.3 }) => {
            ...
            <div style={{
                ...
                <div style={{ marginBottom: '10px' }}>
                    ...
                    <input
                        ...
                        step="1000"
                        value={capital}
                        onChange={(e: React.ChangeEvent<HTMLInputElement>) => setCapital(parseInt(e.target.value))}
                        style={{ width: '100%' }}
                    />
                </div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px', marginBottom: '10px' }}>
                    <div>
                        ...
                        <input
                            ...
                            step="0.5"
                            value={riskPercent}
                            onChange={(e: React.ChangeEvent<HTMLInputElement>) => setRiskPercent(parseFloat(e.target.value))}
                            style={{ width: '100%' }}
                        />
                    </div>
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e: React.ChangeEvent<HTMLInputElement>) => setStopLossPercent(parseFloat(e.target.value))}
                            style={{ width: '100%' }}
                        />
                    </div>
                </div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '8px' }}>
                    <div>
                        ...
                        <input
                            ...
                            step="1"
                            value={winRate}
                            onChange={(e: React.ChangeEvent<HTMLInputElement>) => setWinRate(parseInt(e.target.value))}
                            style={{ width: '100%' }}
                        />
                    </div>
                    <div>
                        ...
                        <input
                            ...
                            step="0.1"
                            value={avgWin}
                            onChange={(e: React.ChangeEvent<HTMLInputElement>) => setAvgWin(parseFloat(e.target.value))}
                            style={{ width: '100%' }}
                        />
                    </div>
                    <div>
                        ...
                        <input
                            ...
                            step="0.1"
                            value={avgLoss}
                            onChange={(e: React.ChangeEvent<HTMLInputElement>) => setAvgLoss(parseFloat(e.target.value))}
                            style={{ width: '100%' }}
                        />
                    </div>
                </div>
...
function RiskCard({ icon, label, value, subtitle, color }: RiskCardProps) {
    return (
        <div style={{
            background: 'rgba(255,255,255,0.03)',
